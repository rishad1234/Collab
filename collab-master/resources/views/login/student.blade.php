        ...
        <div class="row h-100">
            <div class="col-sm-12 registerFormContainer__block">
                <div class="registerFormContainer__block__holdBlock">
                    <form method="POST" action="{{ route('student_login_post')}}">
                        @if ($errors->any())
                        ...
                        <button type="submit" class="btn registerFormContainer__block__holdBlock--submit" role="button" aria-pressed="true">Sign in as student</button>
                    </form>
                </div>
            </div>
        </div>
