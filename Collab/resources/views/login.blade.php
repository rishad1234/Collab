                    ...
                    <div class="loginCover__left__block container">
                        <div class="row">
                            <div class="col-sm-6 loginCover__left__block__holder__left">
                                ...
                                <a href="{{route('login')}}" class="btn landingCover__left--registerTeacher" role="button" aria-pressed="true">Sign in as professor</a>
                            </div>
                            <div class="col-sm-6 loginCover__left__block__holder__right">
                                <h2>For Students</h2>
                                <p>share knowledge, create portfolio, connect with brilliant minds</p>
                                <a href="{{route('login')}}" class="btn landingCover__left--registerStudent" role="button" aria-pressed="true">Sign in as student</a>
                            </div>
                        </div>
                    </div>
                </div>
